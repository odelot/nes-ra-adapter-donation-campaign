...
|<p align="center"><a href="https://www.youtube.com/watch?v=ncUPh_eNoak"><img width="50%" src="https://github.com/odelot/nes-ra-adapter-donation-campaign/blob/main/images/video4.png"></a></p>|**RetroAchievements para Metroid em Hardware Real** – vídeo curto mostrando todo o processo do adaptador, desde a conexão com o Wi-Fi e identificação do jogo até a detecção de uma conquista e seu envio para o RA|2025/03/09|  
