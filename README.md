...
- **Progress**:
<p align="center">
  <img width="400px" height="75px" src="https://geps.dev/progress/0"/>
</p>
...
|<p align="center"><a href="https://www.youtube.com/watch?v=ncUPh_eNoak"><img width="50%" src="https://github.com/odelot/nes-ra-adapter-donation-campaign/blob/main/images/video4.png"></a></p>|**Retro Achievements for Metroid on Real Hardware** - short video showing all the process made by the adapter, since connect to wifi and identify the game, to detect an achievement and upload to RA|2025/03/09|  
